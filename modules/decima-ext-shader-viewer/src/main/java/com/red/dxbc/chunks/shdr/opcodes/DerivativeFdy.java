...
public final class DerivativeFdy extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input;

    public DerivativeFdy(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "DERIV_RTY %s, %s".formatted(output, input);
    }
