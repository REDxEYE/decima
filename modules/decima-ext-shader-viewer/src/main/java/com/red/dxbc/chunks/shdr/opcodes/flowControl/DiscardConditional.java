...
public final class DiscardConditional extends Opcode {

    public final OperandToken0 input;

    public DiscardConditional(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return switch (getTestBoolean()) {
            case TEST_ZERO -> "discard_z %s".formatted(input);
            case TEST_NONZERO -> "discard_nz %s".formatted(input);
        };
    }
