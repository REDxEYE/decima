...
public final class Divide extends FloatMathOperation {
    public Divide(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken, buffer);
    }

    @Override
    public String toString() {
        return "div %s, %s, %s".formatted(output, input0, input1);
    }
