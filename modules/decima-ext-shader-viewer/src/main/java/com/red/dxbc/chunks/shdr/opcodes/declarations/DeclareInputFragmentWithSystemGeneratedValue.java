...
public final class DeclareInputFragmentWithSystemGeneratedValue extends DeclareInput {
    public final NameToken systemGeneratedValue;

    public DeclareInputFragmentWithSystemGeneratedValue(int opcodeToken, @NotNull ByteBuffer buffer) {
    ...
    public String toString() {
        return "dcl_input_ps_sgv %s, %s".formatted(operand, systemGeneratedValue.name());
    }
