...
public final class UIntegerMaximum extends Opcode {
    ...
    public UIntegerMaximum(int opcodeToken, @NotNull ByteBuffer buffer) {
    ...
    public String toString() {
        return "umax %s, %s, %s".formatted(output, input0, input1);
    }
