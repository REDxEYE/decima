...
public final class IntegerMinimum extends Opcode {
    ...
    public IntegerMinimum(int opcodeToken, @NotNull ByteBuffer buffer) {
    ...
    public String toString() {
        return "imin %s, %s, %s".formatted(output, input0, input1);
    }
