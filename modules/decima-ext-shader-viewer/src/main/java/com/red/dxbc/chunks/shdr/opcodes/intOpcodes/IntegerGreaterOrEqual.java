...
public final class IntegerGreaterOrEqual extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input0;
    public final OperandToken0 input1;

    public IntegerGreaterOrEqual(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "ige %s, %s, %s".formatted(output, input0, input1);
    }
