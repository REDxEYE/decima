...
public final class IntegerMaximum extends Opcode {
    ...
    public IntegerMaximum(int opcodeToken, @NotNull ByteBuffer buffer) {
    ...
    public String toString() {
        return "imax %s, %s, %s".formatted(output, input0, input1);
    }
