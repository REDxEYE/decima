...
public final class IntegerEqual extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input0;
    public final OperandToken0 input1;

    public IntegerEqual(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "ieq %s, %s, %s".formatted(output, input0, input1);
    }
