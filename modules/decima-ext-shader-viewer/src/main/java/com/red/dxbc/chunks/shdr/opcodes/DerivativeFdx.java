...
public final class DerivativeFdx extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input;

    public DerivativeFdx(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "DERIV_RTX %s, %s".formatted(output, input);
    }
