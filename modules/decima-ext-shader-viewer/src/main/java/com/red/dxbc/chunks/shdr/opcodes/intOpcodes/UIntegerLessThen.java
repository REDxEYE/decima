...
public final class UIntegerLessThen extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input0;
    public final OperandToken0 input1;

    public UIntegerLessThen(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "ult %s, %s, %s".formatted(output, input0, input1);
    }
