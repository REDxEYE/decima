...
public final class DerivativeFdxCoarse extends Opcode {

    public final OperandToken0 output;
    public final OperandToken0 input;

    public DerivativeFdxCoarse(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken);
    ...
    public String toString() {
        return "DERIV_RTX_COARSE %s, %s".formatted(output, input);
    }
