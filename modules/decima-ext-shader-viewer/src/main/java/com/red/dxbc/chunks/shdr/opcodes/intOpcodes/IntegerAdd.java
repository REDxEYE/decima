...
public final class IntegerAdd extends IntMathOperation {

    public IntegerAdd(int opcodeToken, @NotNull ByteBuffer buffer) {
    ...
    public String toString() {
        return "iadd %s, %s, %s".formatted(output, input0, input1);
    }
