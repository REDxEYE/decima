...
public final class UIntegerDivide extends IntMathOperation {
    public UIntegerDivide(int opcodeToken, @NotNull ByteBuffer buffer) {
        super(opcodeToken, buffer);
    }

    @Override
    public String toString() {
        return "udiv %s, %s, %s".formatted(output, input0, input1);
    }
